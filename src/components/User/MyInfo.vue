                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <div class="grid-content bg-purple" style="height:100%;"><!--设置头像高度-->
                                <img class="photo" :src="this.userinfo.avatar">
                            </div>
                        </el-col>
                        <!--用户昵称和认证按钮-->
                        <el-col :span="16">
                            <div class="grid-content bg-purple" style="margin-left:2rem;" id="username">
                                ...
                                <el-link type="warning" style="margin-left:0.5rem"><update-my-info></update-my-info></el-link>
                            </div>
                        </el-col>
  ...
  data() {
    ...
    created() {
      //向后台发送ajax请求，拿回来渲染页面
        ...
        this.$http.get("http://101.43.198.16:10000/user/getInfo", {
                    headers: { Authorization: this.$store.state.token },
                  }).then((res)=>{
          /** "avatar": "https://bmalimarkdown.oss-cn-beijing.aliyuncs.com/xiegang/1650294312409618.png",
    "phone": "",
    "sex": "0",
    "userId": 10018,
    "userName": "斜杠小青年" */
